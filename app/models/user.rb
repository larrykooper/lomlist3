class User < ActiveRecord::Base
  ...
  INITIAL_ACT_TYPES = [
   ...
   :act_type => "MA",
   :item_desc => "Your sample item. Do an <b>important</b> thing. It might need a link to <a href=\"http://www.example.com\">www.example.com</a>.\n\n<br/><br/>Line breaks are nice! It might have <u>underline</u> or <i>italics</i>! Edit this item or delete it.")
